...
s
        ...
        .content {
            ...
            margin: 0px 10%; /* Adjust margin for navbar */
        ...
        .info-box {
            ...
            border: 1px solid #4e4e4e; /* Border */
        ...
        .bar-graph {
            ...
            margin-left: 10%; /* Center the graph */
        ...
        .btn:hover {
            background-color: #5e5e5e; /* Darker on hover */
        }
    </style>
</head>
<body>
